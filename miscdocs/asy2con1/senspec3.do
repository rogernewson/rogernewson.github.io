...
*
 ...
 illustrating variance formula for Hodges-Lehmann median difference
*;
...
*;
local sdratios "1/4 1/3 1/2 2/3 1 3/2 2 3 4";
local meandiffs "0";
set obs 1;
...
bynote sdr, lo(noteby);
line sens0 u, sort || ,
  by(sdr, note("`noteby'", size(2.5))) subtitle(, size(2.125) height(2.125))
  aspect(1)
  ...
  xsize(6) ysize(6);
graph export senspec3.pdf, replace;
more;
