...
and then uses {helpb metaparm} with the option {cmd:dfcombine(satterthwaite)},
then the confidence limits and {it:P}-values are equivalent to those of the unequal-variance {help ttest:{it:t}-test}.
...
{p 4 13 2}
{bind: }Manual: {hi:[D] append}, {hi:[D] format}
{p_end}
{p 4 13 2}
On-line: help for {helpb append}, {helpb format}
