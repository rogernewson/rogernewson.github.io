...
{cmd:punaf} {ifin} {weight} , [ {opt at:spec(atspec)}
  {opt atz:ero(atspec0)} {opt subpop(subspec)} {opt pr:edict(pred_opt)} {opt vce(vcespec)} {cmdab::no}{opt e:sample} {opt force}
...
The {helpb punafcc}, {helpb regpar}, {helpb margprev} and {helpb marglmean} packages
...
{helpb punafcc}, {helpb regpar}, {helpb margprev}, {helpb marglmean},
