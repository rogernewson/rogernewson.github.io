...
{cmd:punafcc} {ifin} {weight} , [ {opt at:spec(atspec)}
  {opt subpop(subspec)} {opt vce(vcespec)} {cmdab::no}{opt e:sample} {opt force}
...
or {helpb stcox} for survival data.
...
or a Cox proportional hazard model on survival data,
fitted using {helpb stcox}.
{cmd:punafcc} estimates the PUF as the Scenario 0/Scenario 1 mean rate ratio,
restricted to observations representing deaths, if the previous command was {helpb stcox},
...
The packages {helpb punaf}, {helpb regpar}, {helpb margprev} and {helpb marglmean}
...
{psee}
Manual:  {manlink R margins}, {manlink R nlcom}, {manlink R logistic}, {manlink R logit}, {manlink R stcox}, {manlink R glm}
{p_end}

{psee}
{space 2}Help:  {manhelp margins R}, {manhelp nlcom R}, {manhelp logistic R}, {manhelp logit R}, {manhelp stcox R}, {manhelp glm R}{break}
{helpb punaf}, {helpb regpar}, {helpb margprev}, {helpb marglmean},
