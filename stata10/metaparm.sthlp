...
(See Newson (2008), Newson (2006), Newson (2004), Newson (2003) and Newson (2002).)
...
{pstd}
{cmd:satterthwaite} | {cmd:constant}
...
from the {hi:df_j} and the {hi:se_j} by
the Satterthwaite formula (Satterthwaite, 1946),
unless the user specifies the option {helpb metaparm_content_opts:dfcombine(constant)},
in which case {cmd:metaparm} checks that the input degrees of freedom {hi:df_j} are all equal,
...
can be found in Newson (2008),  Newson (2006), Newson (2004), Newson (2003) and Newson (2002).
Other programs are available in the Stata community for carrying out meta-analyses,
including {helpb meta}, written by Stephen Sharp and Jonathan Sterne.
...
{break} {hi:[D] append}, {hi:[R] lincom}, {hi:[R] meta}, {hi:[SVY] svyset}, {hi:[SVY] svy: tabulate oneway}, {hi:[SVY] svy: tabulate twoway}.
{p_end}
{p 4 13 2}
On-line: help for {helpb append}, {helpb lincom}, {helpb svyset}, {helpb svy tabulate oneway}, {helpb svy tabulate twoway}
...
{it:{help parmcip_opts}}, {it:{help metaparm_resultssets}}, {help parmest_resultssets:{it:parmest_resultssets}}
{break} help for {helpb meta}, {helpb dsconcat}, {helpb factext}, {helpb lincomest}, {helpb xcontract} if installed
{p_end}
