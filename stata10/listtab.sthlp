...
{pstd}
More about plain TeX can be found in Knuth (1992).
More about LaTeX can be found in Lamport (1994).
...
More about RTF can be found in Burke (2003),
...
{pstd}
{cmd:listtab} creates (on disk and/or in the Stata log and/or Results window)
...
{pstd}
For more about the use of {helpb listtex} with other packages,
...
{psee}
Manual:  {hi:[D] describe}, {hi:[P] file}, {hi:[D] insheet}, {hi:[D] list}, {hi:[D] outsheet}, {hi:[R] ssc}, {hi:[D] type}
{p_end}
