...
assuming that the parameter estimates are statistically independent.
...
{p 4 13 2}
{bind: }Manual: {hi:[R] estimates}, {hi: [R] test}, {hi:[P] ereturn}, {hi:[D] statsby}
{p_end}
{p 4 13 2}
On-line: help for {help estimates}, {helpb ereturn}, {helpb test}, {helpb statsby}
 {break} help for {helpb parmest}, {helpb parmby}, {helpb parmcip}, {helpb metaparm} if installed
{p_end}
